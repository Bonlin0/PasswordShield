...
/**
 * 接口说明:
 * EncryUtils.getInstance()  获取加密实例
 * String EncryUtils.getInstance().encryptString(plainText,alias_name);
 * String EncryUtils.getInstance().decryptString(ciperText,alias_name);
 */
